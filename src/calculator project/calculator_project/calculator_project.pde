...
void setup() {
  size(280, 280);
  numButtons[0] = new Button(40, 240, 40, 40, '0', #ADC9BF, #C5E6DA);
  ...
  numButtons[10] = new Button(90, 240, 40, 40, 'd', #ADC9BF, #C5E6DA);
  numButtons[11] = new Button(140, 240, 40, 40, 'f', #ADC9BF, #C5E6DA);
  opButtons[0] = new Button(240, 232, 40, 57, '=', #8AB5E8, #B5D0FF);
  opButtons[1] = new Button(240, 166, 40, 57, '√', #8AB5E8, #B5D0FF);
  opButtons[2] = new Button(240, 99, 40, 57, 's', #8AB5E8, #B5D0FF);
  //opButtons[3] = new Button(84, 240, 25, 40, '(', #ADC9BF, #C5E6DA);
  //opButtons[4] = new Button(116, 240, 25, 40, ')', #ADC9BF, #C5E6DA);
  //opButtons[5] = new Button(148, 240, 25, 40, '^', #ADC9BF, #C5E6DA);
  opButtons[3] = new Button(240, 38, 40, 40, 'c', #8AB5E8, #B5D0FF);
  opButtons[4] = new Button(190, 83, 40, 25, '+', #CF5D55, #F75D55);
  opButtons[5] = new Button(190, 116, 40, 25, '-', #CF5D55, #F75D55);
  opButtons[6] = new Button(190, 150, 40, 25, '×', #CF5D55, #F75D55);
  opButtons[7] = new Button(190, 183, 40, 25, '÷', #CF5D55, #F75D55);
  opButtons[8] = new Button(190, 216, 40, 25, 'π', #CF5D55, #F75D55);
  opButtons[9] = new Button(190, 248, 40, 25, '.', #CF5D55, #F75D55);
}
